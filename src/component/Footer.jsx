...
function Footer() {
  return (
    <div className="w-20 md:w-5/6 mx-auto my-20">
      <span className="flex justify-center upperCase text-2xl text-gray-500 font-body">
        _______________________Find us on_____________________
      </span>
      ...
      <footer class="bg-white dark:bg-gray-800 w-full py-8">
        <div class="max-w-screen-xl px-4 mx-auto">
          ...
          <div class="text-center text-gray-500 dark:text-gray-200 pt-10 sm:pt-12 font-normal flex items-center justify-center">
            Copyright 2024 @Edumate
          </div>
        </div>
      </footer>
    </div>
